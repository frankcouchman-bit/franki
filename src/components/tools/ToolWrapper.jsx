      ...
      <>
        <div className="glass-strong rounded-2xl p-8 border border-white/10">
          <div className="text-center py-12">
            ...
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 rounded-xl mb-6">
            ...
            <div>
              {isDemoUser ? (
                <motion.button
                  ...
                  className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl font-bold shadow-lg inline-flex items-center gap-2"
                ...
                <motion.button
                  ...
                  className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl font-bold shadow-lg"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Upgrade to Pro
                ...
                <p className="text-white/60">Check back tomorrow for more tool uses!</p>
              )}
            </div>
          </div>
        </div>
